...
- Hex color output at `build/dist/hex/colors.json` — Machine-generated hex values for all tokens (generated by `npm run build`; consume via `@verdigristech/design-tokens/hex`)
